...
| [`build-principles.md`](build-principles.md) | **Durable** — how to design SP spreads, natures, and items around named benchmarks (speed creep, "always live X", "always KO Y") instead of max/max. Read before recommending a spread. |
